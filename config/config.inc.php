...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	...
	$DOMAIN = "https://{$_SERVER['HTTP_HOST']}/ba-recruitment/trunk/brightcomm/";
	$PUBLIC_HTML = "public_html/";
}
$CONFIG['BASE_DOMAIN_PATH'] = "https://{$_SERVER['HTTP_HOST']}/ba-recruitment/trunk/brightcomm/public_html/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "D:/xampp/htdocs/ba-recruitment/trunk/brightcomm/public_html/public_assets/";
/* 
...
if($CONFIG['LOCAL_DEVELOPMENT']) $CONFIG['LOGIN_PAGE']  = "{$DOMAIN}{$PUBLIC_HTML}{$CONFIG['DEFAULT_MODULES']}";
else  $CONFIG['LOGIN_PAGE']  = "{$DOMAIN}{$PUBLIC_HTML}{$CONFIG['DEFAULT_MODULES']}"; 

$CONFIG['MOBILE_SITE'] =  "{$DOMAIN}mobile_html/";
$CONFIG['ASSETS_DOMAIN_MOBILE'] = $CONFIG['MOBILE_SITE']."assets/"; //new

$CONFIG['SESSION_NAME'] = "marlboro_hunt";
...
if($local){
	...
	$CONFIG['DATABASE'][0]['DATABASE'] 	= "brightcomm_web_2013";
	
	$CONFIG['DATABASE'][1]['HOST'] 		= "localhost";
	$CONFIG['DATABASE'][1]['USERNAME'] 	= "root";
	$CONFIG['DATABASE'][1]['PASSWORD'] 	= "";
	$CONFIG['DATABASE'][1]['DATABASE'] 	= "brightcomm_web_2013";
